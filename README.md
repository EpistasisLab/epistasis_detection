...
We present implementations of efficient algorithms to compute linear regression models for statistical epistasis detection. The models permit varied encodings for interactions using different penetrance functions. They also provide statistical evidence for epistasis.
